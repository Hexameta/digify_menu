        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-sm">
              Scan now from your phone to see the delivery-style menu in action.
            </p>
          </div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <img
            src={digifyMenuLogoDark}
            alt="Digify Menu Logo"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-8">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
            Stop wasting money on printing and start driving revenue with the
            best <strong>digital QR menu system</strong>. Update your pricing in
            seconds and highlight your most profitable dishes with a dynamic,
            mobile-managed menu system.
          </p>
          ...
          <p className="text-sm text-slate-400 italic">
            "Simply place a barcode on your tables for customers to scan - no
            app required."
          </p>
        </div>
        ...
        <div className="relative mx-auto lg:mr-0 w-full max-w-lg">
          {/* Phone Mockup */}
          <div
            className="relative z-10 mx-auto bg-white border-[10px] border-slate-900 rounded-[3rem] shadow-2xl overflow-hidden transform rotate-[-5deg] hover:rotate-0 transition-transform duration-500"
            style={{ width: "280px", aspectRatio: "7.7 / 16" }}
          >
            {/* Mobile Screen */}
            <div className="absolute inset-0 bg-slate-50 overflow-hidden">
              <iframe
                ...
                style={{
                  ...
                  transform: "scale(0.695)", // auto fit into 300px frame
          ...
          <div className="absolute top-10 right-0 lg:-right-8 bg-white/80 backdrop-blur-xl p-4 rounded-2xl border border-white shadow-xl animate-bounce-slow hidden sm:block">
          ...
          <div className="absolute bottom-20 left-0 lg:-left-16 bg-white/80 backdrop-blur-xl p-4 rounded-2xl border border-white shadow-xl animate-bounce-slow delay-700 hidden sm:block">
            <div className="flex items-center gap-3">
...
const features = [
  {
    icon: Layers,
    title: "Modern Delivery-Style UI",
    desc: "A premium interface that feels like a top-tier delivery app. Very easy for customers to use.",
    color: "from-blue-500 to-cyan-500",
  },
  {
    icon: Smartphone,
    title: "Update Prices from Phone",
    desc: "No more re-printing. Update any price or dish instantly directly from your smartphone.",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: Zap,
    title: "Ads & 'Must-Try' Items",
    desc: "Boost sales by showing high-margin items and banner ads inside the menu.",
    color: "from-yellow-500 to-orange-500",
  },
  {
    icon: Check,
    title: "Add-to-List Ordering",
    desc: "Customers build a wishlist for the waiter, speeding up order taking and accuracy.",
    color: "from-green-500 to-emerald-500",
  },
  {
    icon: BookOpen,
    title: "3D Flipbook Experience",
    desc: "Beautiful interactive 3D flipbook for a premium dine-in experience.",
    color: "from-indigo-500 to-violet-500",
  },
  {
    icon: RefreshCw,
    title: "Instant 86'ing",
    desc: "Out of stock? Hide items instantly across all tables in a single click.",
    color: "from-red-500 to-rose-500",
  },
  {
    icon: Gamepad2,
    title: "Gamified Rewards",
    desc: "Engage users with points, badges & challenges to keep them returning.",
    color: "from-orange-500 to-pink-500",
  },
  {
    icon: Leaf,
    title: "Eco-Friendly",
    desc: "Stop struggling with paper waste. Go paperless and reduce your carbon footprint.",
    ...
    <section id="features" className="py-20 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-orange-500 font-bold tracking-wide uppercase mb-2">
            Features
          </h2>
          <h3 className="text-4xl font-bold text-slate-900">
            Premium Digital QR Menu Features
          </h3>
          <p className="text-slate-500 mt-4 max-w-2xl mx-auto">
            Modernize your restaurant in Ernakulam, Bengaluru, or Doha with our
            powerful contactless menu tools.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group p-6 rounded-2xl bg-slate-50 hover:bg-white hover:shadow-xl border border-slate-100 hover:border-orange-100 transition-all hover:-translate-y-1"
            >
              <div
                className={`w-12 h-12 rounded-lg bg-gradient-to-br ${feature.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-md`}
              >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6">
              {[
                {
                  title: "Visual Clarity, Less Doubts",
                  desc: 'Dynamic tags like "Spicy" or "Must-Try" answer guest questions instantly, freeing up your staff and speeding up the ordering process.',
                  icon: Zap,
                },
                {
                  title: "Increase Average Order Value",
                  desc: "Smart upsells and visual menus encourage customers to order more.",
                  icon: TrendingUp,
                },
                {
                  title: "Zero Printing Costs",
                  desc: "Stop spending thousands on paper menus every time you change a price.",
                  icon: Layout,
                },
                {
                  title: "Works on Any Device",
                  desc: "No app download needed. Works in any browser on iOS and Android.",
                  icon: Globe,
                },
                {
                  title: "Cloud-Based & Secure",
                  desc: "Your data is backed up instantly and protected by enterprise security.",
                  icon: ShieldCheck,
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-slate-900 lg:text-slate-50  font-bold text-lg">
                      {item.title}
                    </h4>
                    <p className="text-slate-500 lg:text-slate-50 text-sm">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex justify-center items-center h-full py-8 animate-fade-in">
              <div className="flex gap-4 overflow-x-auto pb-4 px-4 snap-x">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-64 bg-white border border-slate-100 rounded-2xl p-4 shadow-lg snap-center"
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button className="bg-slate-900 text-white p-2 rounded-lg text-xs hover:bg-orange-500 transition-colors">
                        Add +
                      </button>
                    </div>
                  </div>
            ...
            <div className="h-full p-8 animate-fade-in">
              <div className="grid grid-cols-4 gap-4 mb-4">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-24 bg-white shadow-sm border border-slate-100 rounded-xl"
                  ></div>
                ))}
              </div>
    ...
    <section className="py-20 bg-green-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">
          Go Digital. <span className="text-green-600">Go Green.</span>
        </h2>
        <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-10">
          Switch to a sustainable <strong>contactless menu</strong> alternative.
          Reduce waste, save trees, and cut printing costs to zero for your
          restaurant business in the UAE, Qatar, or India.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              name: "Sarah Jenkins",
              role: "Owner, The Urban Cafe",
              text: "Digify transformed our ordering process. The flipbook menu looks amazing on iPads.",
            },
            {
              name: "Marco Rossi",
              role: "Manager, Bella Italia",
              text: "Updating prices used to be a nightmare. Now it takes seconds. Highly recommended.",
            },
            {
              name: "David Chen",
              role: "Founder, Wok & Roll",
              text: "The gamification features actually work. Customers love earning badges for trying new dishes.",
            },
          ].map((t, i) => (
            <div
              key={i}
              className="bg-slate-50 p-8 rounded-2xl shadow-sm border border-slate-100 relative"
            >
              <div className="text-orange-300 text-4xl font-serif absolute top-4 left-4">
                "
              </div>
              <p className="text-slate-600 italic mb-6 mt-4 relative z-10">
                {t.text}
              </p>
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-200 flex flex-col shadow-sm hover:shadow-xl transition-shadow">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-center text-slate-600 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Digital
                Menu Management
              </li>
              <li className="flex items-center text-slate-600 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> QR Code
                Generator
              </li>
              <li className="flex items-center text-slate-600 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Basic
                Analytics
              </li>
              <li className="flex items-center text-slate-600 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Ads &
                Promotions Support
              </li>
            </ul>
            <button
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-orange-500 relative shadow-2xl flex flex-col transform hover:scale-[1.02] transition-transform">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-center text-slate-700 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Everything
                in 6 Months
              </li>
              <li className="flex items-center text-slate-700 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Flipbook
                Mode
              </li>
              <li className="flex items-center text-slate-700 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Advanced
                Rewards System
              </li>
              <li className="flex items-center text-slate-700 text-sm">
                <Check size={16} className="text-orange-500 mr-2" /> Priority
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <img
                src={digifyMenuLogoWhite}
                alt="Digify Menu Logo"
                className="h-10 w-auto"
              />
            </div>
            <p className="text-gray-400 text-sm">
              Empowering restaurants with next-gen digital tools. Digital.
              Dynamic. Delicious.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-4">
              ...
              <div className="text-[10px] text-gray-700 leading-tight">
                Serving restaurants in: Kochi • Ernakulam • Bangalore •
                Hyderabad • Dubai • Abu Dhabi • Doha
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">
            © 2025 Digify Menu. All rights reserved.
          </p>
          <div className="flex gap-6 text-sm text-gray-600">
            <Link to="/privacy" className="hover:text-gray-400 cursor-pointer">
              Privacy Policy
            </Link>
            <Link to="/terms" className="hover:text-gray-400 cursor-pointer">
              Terms of Service
            </Link>
          </div>
        </div>
